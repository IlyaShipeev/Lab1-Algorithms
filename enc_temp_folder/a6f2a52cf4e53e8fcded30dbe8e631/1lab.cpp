...
public:
    ...
    void changeByIndex(int index, const T& value);
    size_t findByNumber(const T& value);
    void add(const T& value);
    void addByIndex(int index, const T& value);
    ...
    Iterator find_begin();
    Iterator find_end();
    ReverseIterator find_rbegin();
    ReverseIterator find_rend();
...
template<typename T>
T List<T>::findByIndex(int index) {
...
template<typename T>
void List<T>::changeByIndex(int index, const T& value)
{
...
template<typename T>
void List<T>:: addByIndex(int index, const T& value) {
...
template<typename T>
typename List<T>::Iterator List<T>::find_begin() {
    return begin(); // begin() уже возвращает Iterator(data)
}

template<typename T>
typename List<T>::Iterator List<T>::find_end() {
    return end();   // end() возвращает Iterator(data + size)
}

template<typename T>
typename List<T>::ReverseIterator List<T>::find_rbegin() {
    return rbegin(); // rbegin() возвращает ReverseIterator(data + size - 1)
}

template<typename T>
typename List<T>::ReverseIterator List<T>::find_rend() {
    return rend();   // rend() возвращает ReverseIterator(data - 1)
}
template<typename T>
...
void runMenu() {
    ...
    while (true) {
        ...
        cout << "------------------------\n";
        cout << "17. Обратный итератор: В конец\n";
        cout << "18. Обратный итератор: Шаг назад\n";
        cout << "19. Обратный итератор: Запись в текущую позицию\n";
        cout << "20. Обратный итератор: Печать текущего элемента\n";

        cout << "------------------------\n";
        cout << "21. Отладка: Наполнить список случайными элементами\n";
        cout << "22. Проверка равенства прямых итераторов (==)\n";
        cout << "23. Проверка неравенства прямых итераторов (!=)\n";
        cout << "24. Проверка равенства обратных итераторов (==)\n";
        cout << "25. Проверка неравенства обратных итераторов (!=)\n";
        cout << "0. Выйти\n";
